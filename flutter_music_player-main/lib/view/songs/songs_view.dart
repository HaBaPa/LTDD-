...
import 'package:music_player/view/songs/equalizer_view.dart'; // Import EqualizerView
...
class _SongsViewState extends State<SongsView>
  ...
  void initState() {
    super.initState();
    controller = TabController(length: 6, vsync: this); // Update length to 6
          ...
          SizedBox(
            ...
            child: TabBar(
              ...
              tabs: const [
                ...
                Tab(text: "ARTISTS"),
                Tab(text: "GENRES"),
                Tab(text: "EQUALIZER"), // Add Equalizer Tab
              ],
            ),
          ),
          Expanded(
            child: TabBarView(
              ...
              children: const [
                ...
                ArtistsView(),
                GenresView(),
                equalizerView(), // Add EqualizerView
              ],
            ),
          )
        ],
